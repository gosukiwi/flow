...
| `flow-spec-skip-unlock-verify.md` | `/flow-spec` | **B** — after APPROVED, evidence unlocked Success Criteria before Task N+1 (not the reviewer) (RED + GREEN on Grok 4.5 High) |
