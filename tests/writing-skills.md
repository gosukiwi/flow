...
| `flow-spec-skip-progress-update.md` | `/flow-spec` | **B** — progress line after each subagent return (task N of M); "don't interrupt" does not skip it (RED + GREEN on Grok 4.5 High; numbered steps sufficient, paragraph removed as redundant) |
