...
4. Review the plan against the codebase: match existing conventions, confirm APIs/helpers exist. Re-check that the plan is clean (zero such alternatives). Unsettled → read the code or ask the user. Don't guess.
